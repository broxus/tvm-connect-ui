...
function useUniversalLink(basePath, params) {
  return [
    basePath,
    (0, import_js_utils.paramsSerializer)({
      apn: params.apn,
      ibi: params.ibi,
      isi: params.isi,
...
var TvmConnectUI = class {
  constructor(params) {
    ...
    (0, import_mobx.makeAutoObservable)(this, {}, { autoBind: true });
  ...
  hasProvider;
  isMobile = (0, import_js_utils2.isMobile)((0, import_js_utils2.getUserAgent)());
  subscribers = [];
  networkId = void 0;
  ...
  async syncHasProvider() {
    const entries = await Promise.all(
      this.tvmWallet.providers.map(async (item) => {
        try {
          if (item.connector.provider instanceof import_everscale_inpage_provider.ProviderRpcClient && typeof item.connector.provider?.hasProvider === "function") {
